...
export const bookmarkPostHandler = function (schema, request) {
  ...
  try {
    ...
    user.bookmarks.push({ _id:post._id, username: post.username, content: post.content, profilePic: post.profilePic, createdAt: post.createdAt, updatedAt: post.updatedAt });
