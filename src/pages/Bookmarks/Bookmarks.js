                            ...
                            <div>
                                ...
                                <div className="">
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="col-md-4"><img className="actions cursor-pointer" src={bookmarks.find((bookmark) => bookmark._id === post._id) !== undefined ? "./assets/images/bookmark-green.png" : "./assets/images/bookmark-black.png"} onClick={() => handleRemoveBookmarkClick(post._id)}></img></div>
                                    </div>
                                </div>
                            </div>
